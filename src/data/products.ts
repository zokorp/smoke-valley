...
// Phase 1 placeholder/sample products only. Replace these with the real catalog before launch.
// These entries do not claim current inventory, price, availability, or online ordering eligibility.
export const products: Product[] = [
  ...
  sampleProduct({
    ...
    description: 'A placeholder listing for Lost Mary disposable products. Replace details with real catalog data before launch.',
    image: '/images/products/product-placeholder-vape.svg',
  ...
  sampleProduct({
    ...
    description: 'A placeholder product prepared for future catalog import. Availability is not guaranteed.',
    image: '/images/products/product-placeholder-vape.svg',
  ...
  sampleProduct({
    ...
    description: 'A sample Smok device listing for the Phase 1 catalog. Call for current device options.',
    image: '/images/products/product-placeholder-vape.svg',
  ...
  sampleProduct({
    ...
    description: 'A placeholder category listing for rolling paper products and related accessories.',
  ...
  sampleProduct({
    ...
    description: 'A placeholder kratom listing for the static catalog. Consult a qualified professional before use when appropriate.',
    image: '/images/products/product-placeholder-kratom.svg',
